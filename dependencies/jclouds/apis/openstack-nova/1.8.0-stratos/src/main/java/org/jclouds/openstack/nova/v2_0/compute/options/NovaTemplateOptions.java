...
public class NovaTemplateOptions extends TemplateOptions implements Cloneable {
   ...
   @Override
   public int hashCode() {
      return Objects.hashCode(super.hashCode(), autoAssignFloatingIp, floatingIpPoolNames, securityGroupNames, generateKeyPair, keyPairName, userData, diskConfig, configDrive, availabilityZone, novaNetworks);
   }
    ...
    * <h3>Note</h3>
    * 
    * This requires that {@link org.jclouds.openstack.nova.v2_0.NovaApi#getExtensionApiForZone(String)} to return
