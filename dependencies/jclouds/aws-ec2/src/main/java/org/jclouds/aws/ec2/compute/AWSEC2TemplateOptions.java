...
public class AWSEC2TemplateOptions extends EC2TemplateOptions implements Cloneable {
   ...
   @Override
   public int hashCode() {
      return Objects.hashCode(super.hashCode(), monitoringEnabled, publicIpAddressAssociated, placementGroup,
              noPlacementGroup, subnetId, spotPrice, spotOptions, groupIds, iamInstanceProfileArn,
              iamInstanceProfileName, privateIpAddress);
   }
