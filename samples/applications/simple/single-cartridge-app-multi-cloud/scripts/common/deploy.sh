...
network_partitions_path=`cd "${script_path}/../../../../../network-partitions/multi"; pwd`
...
curl -X POST -H "Content-Type: application/json" -d "@${network_partitions_path}/ap-southeast-1-nw-partition.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/networkPartitions
curl -X POST -H "Content-Type: application/json" -d "@${network_partitions_path}/ap-southeast-2-nw-partition.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/networkPartitions
curl -X POST -H "Content-Type: application/json" -d "@${network_partitions_path}/openstack-nw-partition.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/networkPartitions
...
curl -X POST -H "Content-Type: application/json" -d "@${application_policies_path}/multi-cloud-application-policy.json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/applicationPolicies
...
curl -X POST -H "Content-Type: application/json" -k -v -u admin:admin https://${host_ip}:${host_port}/api/applications/single-cartridge-multi-cloud-app/deploy/multi-cloud-application-policy
