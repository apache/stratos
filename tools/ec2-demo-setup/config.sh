...
CARTRIDGE_DEFINITIONS=/opt/apache-stratos-cc-4.0.0-SNAPSHOT/repository/deployment/server/cartridges
SERVICE_DEFINITIONS=/opt/apache-stratos-cc-4.0.0-SNAPSHOT/repository/deployment/server/services
PAYLOADS=/opt/apache-stratos-cc-4.0.0-SNAPSHOT/repository/resources/payload
SC_CONF_MT=/opt/apache-stratos-sc-4.0.0-SNAPSHOT/repository/conf/multitenancy
MYSQL_JAR=/opt/mysql-connector-java-5.1.25.jar
MYSQL_COPY_PATH=/opt/apache-stratos-sc-4.0.0-SNAPSHOT/repository/components/lib
...
mv $TEMP_CONFIG_DIR/cloud-controller.xml.tmp /opt/apache-stratos-cc-4.0.0-SNAPSHOT/repository/conf/cloud-controller.xml
chown ubuntu:ubuntu /opt/apache-stratos-cc-4.0.0-SNAPSHOT/repository/conf/cloud-controller.xml
...
mv $TEMP_CONFIG_DIR/cartridge-config.properties.tmp /opt/apache-stratos-sc-4.0.0-SNAPSHOT/repository/conf/cartridge-config.properties
chown ubuntu:ubuntu /opt/apache-stratos-sc-4.0.0-SNAPSHOT/repository/conf/cartridge-config.properties
mv $TEMP_CONFIG_DIR/agent.properties.tmp /opt/apache-stratos-agent-4.0.0-SNAPSHOT/repository/conf/agent.properties
chown ubuntu:ubuntu /opt/apache-stratos-agent-4.0.0-SNAPSHOT/repository/conf/agent.properties
