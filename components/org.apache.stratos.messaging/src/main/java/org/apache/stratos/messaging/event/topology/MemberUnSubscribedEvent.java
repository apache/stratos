...
/**
 * This event is fired by Cloud Controller when a member left it's cluster.
 */
public class MemberUnSubscribedEvent extends TopologyEvent implements Serializable {
