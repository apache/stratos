 ...
 */
public class AppStatusClusterTerminatedEvent extends StatusEvent {
    ...
    public AppStatusClusterTerminatedEvent(String appId, String serviceName, String clusterId) {
