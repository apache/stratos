 ...
 */
public class AppStatusClusterTerminatingEvent extends StatusEvent {
    ...
    public AppStatusClusterTerminatingEvent(String appId, String serviceName, String clusterId) {
