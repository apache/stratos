...
public class Topology implements Serializable {
    ...
    public void addService(Service service) {
        this.serviceMap.put(service.getDomainName(), service);
    }
    ...
    public Service getService(String domainName) {
        return this.serviceMap.get(domainName);
    }
}
