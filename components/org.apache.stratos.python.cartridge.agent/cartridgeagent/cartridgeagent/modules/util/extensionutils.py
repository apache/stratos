...
def add_payload_parameters(env_params):
    ...
    env_params["EXPORT_METADATA_KEYS"] = cartridge_agent_config.export_metadata_keys
    env_params["IMPORT_METADATA_KEYS"] = cartridge_agent_config.import_metadata_keys
