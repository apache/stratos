...
public class MetaDataServiceClientManager {
    ...
    private void initialize() {
        ...
        metaDataServiceClient = new DefaultMetaDataServiceClient(metaDataClientConfig.getMetaDataServiceBaseUrl());
        metaDataServiceClient.initialize();
        //TODO:  load the relevant customized class using customDataExtractorClassName
