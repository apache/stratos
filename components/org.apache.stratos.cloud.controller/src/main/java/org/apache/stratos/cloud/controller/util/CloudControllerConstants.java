...
public final class CloudControllerConstants {
	...
	public static final String CARTRIDGES_ELEMENT_XPATH = "/" + CARTRIDGES_ELEMENT + "/" +
	                                                      CARTRIDGE_ELEMENT;
	 ...
	 * Directories
	 */
	public static final String SERVICES_DIR = CarbonUtils.getCarbonRepository() + File.separator +
	                                          "services" + File.separator;

	/**
	 * Topology sync related constants
	 */
	public static final String TOPOLOGY_FILE_PATH = CarbonUtils.getCarbonConfigDirPath() +
	                                                File.separator + "service-topology.conf";
