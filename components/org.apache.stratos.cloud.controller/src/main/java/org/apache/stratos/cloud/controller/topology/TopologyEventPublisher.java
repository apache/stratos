...
public class TopologyEventPublisher {
    ...
    public static void sendClusterRemovedEvent(ClusterContext ctxt, String deploymentPolicy) {
        ...
        ClusterRemovedEvent clusterRemovedEvent = new ClusterRemovedEvent(ctxt.getCartridgeType(), ctxt.getClusterId(), deploymentPolicy, ctxt.isLbCluster(), ctxt.isKubernetesCluster());
