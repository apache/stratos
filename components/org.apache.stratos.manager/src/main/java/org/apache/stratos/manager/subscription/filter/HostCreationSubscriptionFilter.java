...
/**
 *	Responsible for making a subscription for a Docker Host,
 *	when required.
 */
public class HostCreationSubscriptionFilter implements SubscriptionFilter {
	
	private static Log log = LogFactory.getLog(HostCreationSubscriptionFilter.class);
