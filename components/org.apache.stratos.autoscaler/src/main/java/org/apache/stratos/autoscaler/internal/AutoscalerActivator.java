...
/**
 * Activator for the Autoscaler  Bundle
 */
public class AutoscalerActivator implements BundleActivator {
	private static final Log log = LogFactory.getLog(AutoscalerActivator.class);
