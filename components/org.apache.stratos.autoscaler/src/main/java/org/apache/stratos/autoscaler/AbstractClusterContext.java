...
public class AbstractClusterContext implements Serializable {
    ...
    public AbstractClusterContext(String kubernetesClusterId, String clusterId) {
    ...
    private class PendingMemberWatcher implements Runnable {
        private AbstractClusterContext ctxt;

        public PendingMemberWatcher(AbstractClusterContext ctxt) {
            this.ctxt = ctxt;
        }
    ...
    private class ObsoletedMemberWatcher implements Runnable {
        ...
        public ObsoletedMemberWatcher(AbstractClusterContext ctxt) {
            this.ctxt = ctxt;
        }
